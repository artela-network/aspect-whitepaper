...
\input{sections/02-extensibility}
\input{sections/03-aspect-programming}
\input{sections/04-join-point-model}
\input{sections/05-implementation-aspect-boost}
\input{sections/06-new-world-with-aspect}
\input{sections/07-conclusion}
\input{sections/08-miscellanea}
\newpage
